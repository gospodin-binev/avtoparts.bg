...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand pull-left" href="{{ url('/') }}">
                    <img class="img-responsive" alt="www.avtoparts.bg" src="/images/logo-3.png"> 
                </a>
            </div>
	...
	<footer class="footer">
      <div class="container">
        <p class="text-muted"><strong>AVTOPARTS.BG</strong> - Всички права запазени. | Уеб дизайн: <a style="color: orange;" href="http://binev.eu/"><strong>Binev.eu</strong></a></p>
      </div>
    </footer>
        ...
        $('#brand_id').on('change',function(e){
            ...
            $.get('/ajax-model?brand_id=' + brand_id, function(data){
                ...
                $.each(data, function(index, modelObj){
                    ...
                    $('#model').append('<option value="'+modelObj.id+'">'+modelObj.name+'</option>');
        ...
        $('#category_id').on('change',function(e){
            ...
            $.get('/ajax-subcat?cat_id=' + cat_id, function(data){
                ...
                $.each(data, function(index, subcatObj){
                    ...
                    $('#subcategory-id').append('<option value="'+subcatObj.id+'">'+subcatObj.name+'</option>');
